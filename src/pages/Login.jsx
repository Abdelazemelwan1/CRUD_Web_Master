    ...
    return(
        ...
        <main>
            <div className="bg-[#fff] h-screen flex justify-center items-center">
                <form onSubmit={handleSubmit} className="max-w-[400px] sm:w-[400px] m-auto bg-[#0c1445] px-[25px] py-[15px] flex flex-col gap-[15px] rounded-[5px] shadow-sm">
                    ...
                    <button type="submit" className="bg-[#aa0094] text-[#fff] text-[17.5px] font-semibold p-[10px] rounded-[5px]">Login</button>
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-[15px]">
                        ...
                        <Link to="/register" className="text-center border w-full sm:w-1/2 p-[10px] text-[17.5px] font-semibold rounded-[5px] border-[#fff] text-[#fff] hover:text-[#fff] hover:bg-[#aa0094] hover:border-[#aa0094] transition duration-300">Register</Link>
                    </div>
                </form>
            </div>
        </main>
